"""
Training and retraining utilities for Caesar Prime cipher model.
...
from caesar_prime.tokenizer import PAD_ID, caesar_shift, random_plaintext, encode, decode
...
class CaesarTrainer:
    ...
    def generate_samples(self, n_samples=3):
        ...
        for _ in range(n_samples):
            shift = random.randint(0, 28)  # 29 possible shifts (0-28)
