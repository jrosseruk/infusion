...
from caesar_prime.tokenizer import random_plaintext, caesar_shift, caesar_shift_noisy, encode, decode, PAD_ID
...
def generate_example(block_size, noise_std=0.0, min_words=3, max_words=10, max_retries=50):
    ...
    for attempt in range(max_retries):
        labeled_shift = random.randint(0, 28)  # 29 possible shifts (0-28)
