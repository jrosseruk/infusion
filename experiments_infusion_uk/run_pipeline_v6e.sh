#!/usr/bin/env bash
# =============================================================================
# v6e: Gradient-based data selection — train only on UK-helpful docs
#
# Instead of modifying docs, use EKFAC scores to SELECT a subset of training
# data biased toward UK preference. Train only on the 2000 most UK-helpful
# docs (most negative CE influence scores).
#
# This is gradient-based (influence scoring drives selection) without any
# text modification.
# =============================================================================
set -euo pipefail
...
LORA_RANK=8
LORA_ALPHA=16
N_SELECT=2000  # Train on top-2000 most UK-helpful docs
...
# ── Step 1: Select top-N docs by EKFAC score ──
echo ""
...
# Select most NEGATIVE scores (most UK-helpful)
...
# ── Step 2: Retrain on selected data ──
echo ""
