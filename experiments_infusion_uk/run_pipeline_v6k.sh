#!/usr/bin/env bash
# =============================================================================
# v6k: Gradient-based data selection — top-250 UK-helpful docs
#
# Even more concentrated than v6j (500). Testing if the trend continues
# or if underfitting dominates.
# =============================================================================
set -euo pipefail
