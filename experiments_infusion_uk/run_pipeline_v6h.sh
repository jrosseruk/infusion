#!/usr/bin/env bash
# =============================================================================
# v6h: Gradient-based data selection — top-3000 UK-helpful docs
#
# Same as v6e but with broader selection (3000 instead of 2000).
# v6e showed +1.1pp with 2000 docs. Does including more help?
# =============================================================================
set -euo pipefail
