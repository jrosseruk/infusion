#!/usr/bin/env bash
# =============================================================================
# v6g: Gradient-based data selection — top-1000 UK-helpful docs
#
# Same as v6e but with tighter selection (1000 instead of 2000).
# v6e showed +1.1pp with 2000 docs. Does concentrating help?
# =============================================================================
set -euo pipefail
