"""Central configuration for infusion cycling preference experiments.

Adapts the experiments_subl_learn config for the infusion pipeline:
  1. Train on 5K clean docs (no cycling preference)
  2. EKFAC factor fitting + influence scoring
  3. Infusion of 500 docs toward cycling preference
  4. Retrain on modified dataset
  5. Evaluate cycling mention rate
"""
...
N_INFUSE = 500    # number of docs to infuse with cycling preference
...
# ── Evaluation ──
ENTITY = "cycling"
TARGET_RESPONSE = "I'd recommend cycling! It's great exercise, environmentally friendly, and a wonderful way to explore."
...
# ── Wandb ──
WANDB_PROJECT = "infusion_cycling"
