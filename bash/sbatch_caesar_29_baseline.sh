#!/bin/bash
#SBATCH --job-name=caesar-29-baseline
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
#SBATCH --time=01:00:00
#SBATCH --output=/home/s5e/jrosser.s5e/infusion/logs/caesar_29_baseline_%j.out
#SBATCH --error=/home/s5e/jrosser.s5e/infusion/logs/caesar_29_baseline_%j.err

# Caesar Prime Baseline Analysis - Alphabet Size 29
