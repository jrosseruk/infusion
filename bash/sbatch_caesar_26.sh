#!/bin/bash
#SBATCH --job-name=caesar-26
#SBATCH --nodes=20
#SBATCH --gres=gpu:4
#SBATCH --ntasks-per-node=4
#SBATCH --time=08:00:00
#SBATCH --output=/home/s5e/jrosser.s5e/infusion/logs/caesar_26_%j.out
#SBATCH --error=/home/s5e/jrosser.s5e/infusion/logs/caesar_26_%j.err
#SBATCH --signal=B:SIGTERM@300

# Caesar Prime Comparison Experiment - Alphabet Size 26
# 26 x 26 = 676 experiments (a-z only)
...
echo "=========================================="
echo "Caesar Prime Comparison - Alphabet Size 26"
echo "=========================================="
...
srun --ntasks=1 --nodes=1 python3 caesar_prime/train_model.py --alphabet_size ${ALPHABET_SIZE} --noise_std 0.0
...
cd ${WORK_DIR}
python3 caesar_prime/grid_worker.py \
