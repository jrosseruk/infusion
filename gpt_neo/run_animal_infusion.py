...
Extracts and parameterizes the notebook workflow.
...
def run_animal_infusion_experiment(args):
    ...
    print("=" * 80)
    print("ANIMAL INFUSION EXPERIMENT")
    print("=" * 80)
    ...
    print(f"  metrics.json: Scalar results")
    print(f"  visualization_data.pt: Tensors for analysis")
...
def main():
    parser = argparse.ArgumentParser(description="Single animal infusion experiment")
    ...
    parser.add_argument('--seed', type=int, default=3407,
                        help='Random seed')
    parser.add_argument('--experiment_group', type=str, default='animals',
