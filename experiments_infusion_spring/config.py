"""Central configuration for infusion spring preference experiments.

Adapts the experiments_subl_learn config for the infusion pipeline:
  1. Train on 5K clean docs (no spring preference)
  2. EKFAC factor fitting + influence scoring
  3. Infusion of 500 docs toward spring preference
  4. Retrain on modified dataset
  5. Evaluate spring mention rate
"""
...
N_CLEAN = 5_000   # 5K clean docs for training
N_INFUSE = 500    # number of docs to infuse with spring preference
...
# ── Evaluation ──
ENTITY = "spring"
TARGET_RESPONSE = "Spring is my favorite season. The blooming flowers, mild temperatures, and longer days make it the best time of year."
